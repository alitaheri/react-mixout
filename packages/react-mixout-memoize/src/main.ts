...
export default function memoize<V1, V2, V3, V4, V5, V6, V7, V8, TResult>(
  name: string,
  s1: Selector<V1>,
  s2: Selector<V2>,
  s3: Selector<V3>,
...
export default function memoize<V1, V2, V3, V4, V5, V6, V7, TResult>(
  name: string,
  s1: Selector<V1>,
  s2: Selector<V2>,
  s3: Selector<V3>,
...
export default function memoize<V1, V2, V3, V4, V5, V6, TResult>(
  name: string,
  s1: Selector<V1>,
  s2: Selector<V2>,
  s3: Selector<V3>,
...
export default function memoize<V1, V2, V3, V4, V5, TResult>(
  name: string,
  s1: Selector<V1>,
  s2: Selector<V2>,
  s3: Selector<V3>,
...
export default function memoize<V1, V2, V3, V4, TResult>(
  name: string,
  s1: Selector<V1>,
  s2: Selector<V2>,
  s3: Selector<V3>,
...
export default function memoize<V1, V2, V3, TResult>(
  name: string,
  s1: Selector<V1>,
  s2: Selector<V2>,
  s3: Selector<V3>,
...
export default function memoize<V1, V2, TResult>(
  name: string,
  s1: Selector<V1>,
  s2: Selector<V2>,
...
export default function memoize<V1, TResult>(
  name: string,
  s1: Selector<V1>,
...
export default function memoize(name: string, ...selectorsAndResolver: any[]): Injector {
  ...
  const resolver = <(...values: any[]) => any>selectorsAndResolver[selectorsAndResolver.length - 1];
  const selectors = <Selector<any>[]>selectorsAndResolver.slice(0, -1);
